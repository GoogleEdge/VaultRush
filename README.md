...
- 自动打开主菜单由 `settings.menu.auto-open-on-join` 控制；关闭自动打开不会关闭“打开菜单”物品或 `/vr menu`。
...
| `settings.menu.item.material` | `NETHER_STAR` | “打开菜单”菜单物品材质；空气材质会回退为下界之星 |
